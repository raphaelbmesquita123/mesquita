      ...
      <div className='grid grid-cols-2 relative gap-20 p-20 mt-14 rounded-lg max-w-[1400px] bg-blue-700 shadow-2xl z-20 -2xl:grid-cols-1 -xl:pt-20 -xl:mt-28 -xl:p-10 -md:p-5 -md:pt-20'>
        ...
        <FormProvider {...form}>
          <form
            ...
            className='flex flex-col gap-6 bg-gray-100 rounded-md p-8 shadow-2xl'
          >
            <FormInput
              id='name'
              label='Name'
            ...
            />
            <button className='bg-blue-900 h-[80px] rounded-md transition-all   duration-300 ease-in-out hover:bg-blue-800 active:scale-[96%]'>
              <span className='font-oswald text-2xl text-white'>Enviar</span>
            </button>
            {/* <Button label='Send Message' icon={<MdEmail />} /> */}
          </form>
        </FormProvider>
      </div>
    </div>
